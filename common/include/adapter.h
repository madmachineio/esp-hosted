...
typedef enum {
	ESP_PRIV_EVENT_INIT,
	ESP_PRIV_EVENT_STA_CONNECTED,
	ESP_PRIV_EVENT_STA_DISCONNECTED,
	ESP_PRIV_EVENT_STA_AUTORETRY,
	ESP_PRIV_EVENT_AP_STACONNECTED,
	ESP_PRIV_EVENT_AP_STADISCONNECTED
} ESP_PRIV_EVENT_TYPE;
