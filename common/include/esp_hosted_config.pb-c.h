...
typedef struct _EspHostedCmdSetMadSwiftPriv EspHostedCmdSetMadSwiftPriv;
typedef struct _EspHostedRespSetMadSwiftPriv EspHostedRespSetMadSwiftPriv;
...
typedef enum _EspHostedMadSwiftPrivType {
  ESP_HOSTED_MAD_SWIFT_PRIV_TYPE__MAD_SWIFT_PRIV_TYPE_CUSTOM = 0,
  ESP_HOSTED_MAD_SWIFT_PRIV_TYPE__MAD_SWIFT_PRIV_TYPE_LED_SET = 1
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(ESP_HOSTED_MAD_SWIFT_PRIV_TYPE)
...
typedef enum _EspHostedConfigMsgType {
  ...
  ESP_HOSTED_CONFIG_MSG_TYPE__TypeCmdSetMadSwiftPriv = 40,
  ESP_HOSTED_CONFIG_MSG_TYPE__TypeRespSetMadSwiftPriv = 41
...
#define ESP_HOSTED_RESP_GET_APCONFIG__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&esp_hosted_resp_get_apconfig__descriptor) \
    , {0,NULL}, {0,NULL}, 0, 0, ESP_HOSTED_ENCRYPTION_MODE__Type_Open, 0 }
...
#define ESP_HOSTED_RESP_GET_SOFT_APCONFIG__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&esp_hosted_resp_get_soft_apconfig__descriptor) \
    , {0,NULL}, {0,NULL}, 0, ESP_HOSTED_ENCRYPTION_MODE__Type_Open, 0, 0, 0, 0 }
...
#define ESP_HOSTED_CMD_SET_SOFT_APCONFIG__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&esp_hosted_cmd_set_soft_apconfig__descriptor) \
    , (char *)protobuf_c_empty_string, (char *)protobuf_c_empty_string, 0, ESP_HOSTED_ENCRYPTION_MODE__Type_Open, 0, 0, 0 }
...
#define ESP_HOSTED_SCAN_RESULT__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&esp_hosted_scan_result__descriptor) \
    , {0,NULL}, 0, 0, {0,NULL}, ESP_HOSTED_ENCRYPTION_MODE__Type_Open }
...
#define ESP_HOSTED_CMD_SET_VENDOR_SPECIFIC_IE__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&esp_hosted_cmd_set_vendor_specific_ie__descriptor) \
    , 0, ESP_HOSTED_VENDOR_IETYPE__VND_IE_TYPE_BEACON, ESP_HOSTED_IEID__VND_IE_ID_0, {0,NULL} }
...
struct  _EspHostedCmdSetMadSwiftPriv
{
  ProtobufCMessage base;
  EspHostedMadSwiftPrivType type;
  ProtobufCBinaryData payload;
  int32_t len;
};
#define ESP_HOSTED_CMD_SET_MAD_SWIFT_PRIV__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&esp_hosted_cmd_set_mad_swift_priv__descriptor) \
    , ESP_HOSTED_MAD_SWIFT_PRIV_TYPE__MAD_SWIFT_PRIV_TYPE_CUSTOM, {0,NULL}, 0 }


struct  _EspHostedRespSetMadSwiftPriv
{
  ProtobufCMessage base;
  int32_t resp;
};
#define ESP_HOSTED_RESP_SET_MAD_SWIFT_PRIV__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&esp_hosted_resp_set_mad_swift_priv__descriptor) \
    , 0 }
...
typedef enum {
  ...
  ESP_HOSTED_CONFIG_PAYLOAD__PAYLOAD_CMD_SET_MAD_SWIFT_PRIV = 50,
  ESP_HOSTED_CONFIG_PAYLOAD__PAYLOAD_RESP_SET_MAD_SWIFT_PRIV = 51
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(ESP_HOSTED_CONFIG_PAYLOAD__PAYLOAD)
...
struct  _EspHostedConfigPayload
{
  ...
  union {
    ...
    EspHostedCmdSetMadSwiftPriv *cmd_set_mad_swift_priv;
    EspHostedRespSetMadSwiftPriv *resp_set_mad_swift_priv;
  };
};
#define ESP_HOSTED_CONFIG_PAYLOAD__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&esp_hosted_config_payload__descriptor) \
    , ESP_HOSTED_CONFIG_MSG_TYPE__TypeCmdGetMACAddress, ESP_HOSTED_CONFIG_PAYLOAD__PAYLOAD__NOT_SET, {0} }
...
void   esp_hosted_resp_get_wi_fi_curr_txpower__free_unpacked
                     (EspHostedRespGetWiFiCurrTXPower *message,
                      ProtobufCAllocator *allocator);
/* EspHostedCmdSetMadSwiftPriv methods */
...
void   esp_hosted_cmd_set_mad_swift_priv__free_unpacked
                     (EspHostedCmdSetMadSwiftPriv *message,
                      ProtobufCAllocator *allocator);
/* EspHostedRespSetMadSwiftPriv methods */
...
typedef void (*EspHostedRespGetWiFiCurrTXPower_Closure)
                 (const EspHostedRespGetWiFiCurrTXPower *message,
                  void *closure_data);
typedef void (*EspHostedCmdSetMadSwiftPriv_Closure)
                 (const EspHostedCmdSetMadSwiftPriv *message,
                  void *closure_data);
typedef void (*EspHostedRespSetMadSwiftPriv_Closure)
                 (const EspHostedRespSetMadSwiftPriv *message,
                  void *closure_data);
...
extern const ProtobufCEnumDescriptor    esp_hosted_mad_swift_priv_type__descriptor;
...
extern const ProtobufCMessageDescriptor esp_hosted_cmd_set_mad_swift_priv__descriptor;
extern const ProtobufCMessageDescriptor esp_hosted_resp_set_mad_swift_priv__descriptor;
