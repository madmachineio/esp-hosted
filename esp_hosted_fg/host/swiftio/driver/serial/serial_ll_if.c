...
static void* to_serial_ll_intf_queue[MAX_SERIAL_INTF];
							 ...
							 uint16_t * rlen)
{
	...
	*rlen = 0 ;
	 ...
	 */
	if (0 != swifthal_os_mq_recv(serial_ll_hdl->queue, &buf_handle, -1)) {
...
/**
  ...
  * @retval SWIFTIO_FAIL/SWIFTIO_OK
  */
static int serial_ll_write(const serial_ll_handle_t * serial_ll_hdl,
	uint8_t * wbuffer, const uint16_t wlen)
{
...
/**
  ...
  */
swiftio_ret_t serial_ll_rx_handler(interface_buffer_handle_t * buf_handle)
{
